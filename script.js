...
function updater() {
    if (stat == 0) {
        ...
        element.innerHTML = "You need to go to school.. FUCK school... </br>Are you sure about not suiciding?.. </br><b>What should you do?<b></br>" +
        ...
        element.innerHTML = "You're going to sleep.</br>You woke up.</br>What should you do?";
        stat = 2;
    }
}
